...
static asn_oer_constraints_t asn_OER_memb_h323_ID_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
...
asn_TYPE_member_t asn_MBR_AliasAddress_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AliasAddress, choice.h323_ID),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_h323_ID_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_h323_ID_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_TYPE_tag2member_t asn_MAP_AliasAddress_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* h323-ID */
