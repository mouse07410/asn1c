...
asn_TYPE_member_t asn_MBR_H320Caps_1[] = {
	{ ATF_POINTER, 2, offsetof(struct H320Caps, nonStandardData),
	...
	{ ATF_POINTER, 1, offsetof(struct H320Caps, dataRatesSupported),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct H320Caps, supportedPrefixes),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_H320Caps_oms_1[] = { 0, 1 };
