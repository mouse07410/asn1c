...
asn_TYPE_member_t asn_MBR_T120OnlyCaps_1[] = {
	{ ATF_POINTER, 2, offsetof(struct T120OnlyCaps, nonStandardData),
	...
	{ ATF_POINTER, 1, offsetof(struct T120OnlyCaps, dataRatesSupported),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct T120OnlyCaps, supportedPrefixes),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_T120OnlyCaps_oms_1[] = { 0, 1 };
