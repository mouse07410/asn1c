...
asn_TYPE_member_t asn_MBR_SecurityCapabilities_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SecurityCapabilities, nonStandard),
	...
	{ ATF_POINTER, 1, offsetof(struct SecurityCapabilities, encryption),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SecurityCapabilities, authenticatedSupplier),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SecurityCapabilities, authenticatedSignalling),
		...
		0, 0, /* No default value */
		"authenticatedSignalling"
		},
	{ ATF_POINTER, 1, offsetof(struct SecurityCapabilities, certificateCapability),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_CertificateCapability,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_SecurityCapabilities_oms_1[] = { 0, 1, 4 };
...
static const asn_TYPE_tag2member_t asn_MAP_SecurityCapabilities_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* encryption */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* authenticatedSupplier */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* authenticatedSignalling */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* certificateCapability */
};
