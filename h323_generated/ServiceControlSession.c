...
static asn_oer_constraints_t asn_OER_memb_sessionId_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_member_t asn_MBR_ServiceControlSession_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ServiceControlSession, sessionId),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sessionId_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct ServiceControlSession, contents),
	...
	{ ATF_POINTER, 1, offsetof(struct ServiceControlSession, reason),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ServiceControlSession_reason,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ServiceControlSession_oms_1[] = { 1, 2 };
