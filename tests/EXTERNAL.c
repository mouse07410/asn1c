 ...
 * 	found in "/home/runner/work/asn1c/asn1c/skeletons/standard-modules/ASN1C-UsefulInformationObjectClasses.asn1"
...
static asn_TYPE_descriptor_t asn_DEF_encoding __attribute__((alias("asn_DEF_encoding_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_encoding_5;
asn_TYPE_descriptor_t asn_DEF_encoding;
__attribute__((constructor)) static void asn_DEF_encoding_alias_init(void) {
